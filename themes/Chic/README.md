...
- **Waline Comment System** integrated (see Configuration below)
...
### Features
- Lightweight comment system with emoji reactions
- GitHub-based comment management
- Dark mode support
- Visitor tracking
...
waline:
  enable: true
  serverURL: https://your-waline-server.example.com  # Required: Your Waline server URL
  darkMode: true
```

### Usage
1. Deploy a Waline server (see [official guide](https://waline.js.org/guide/get-started.html))
2. Set your `serverURL` in the configuration above
3. Comments will appear automatically on post pages
```
</details>
<br>
